...
public class ModelDriveable extends ModelBase 
{
	...
	/** For rendering from GUIs */
	public void renderTurretLoss(DriveableType type)
	{
		 // let it be handled in ModelVehicle only or else it will render the core. We dont want that for turret only!
		GL11.glPushMatrix();
