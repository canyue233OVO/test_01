...
public class ClientProxy extends ServerProxy
{
	...
	@Override
	public void addBlip(float x, float y, float z, float posX, float posZ, int type, float Distance) {
		
		RenderRadarScreen.blips.add(new Blip(x, y, z, posX, posZ, type, Distance));
	}
