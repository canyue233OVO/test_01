...
public class ModelS451M extends ModelPlane //Same as Filename
{
	...
	{
		bodyDoorOpenModel[0] = new ModelRendererTurbo(this, 57, 65, textureX, textureY); // Box 142
		bodyDoorOpenModel[1] = new ModelRendererTurbo(this, 257, 33, textureX, textureY); // Box 143
		bodyDoorOpenModel[2] = new ModelRendererTurbo(this, 57, 65, textureX, textureY); // Box 148
		bodyDoorOpenModel[3] = new ModelRendererTurbo(this, 257, 33, textureX, textureY); // Box 149

		bodyDoorOpenModel[0].addShapeBox(0F, -1F, -36F, 26, 3, 36, 0F,-2F, 1.5F, 0F, -11F, 1.5F, 0.5F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, -2F, -3F, 0F, -11F, -3F, 0.5F, -0.5F, 0.5F, 0F, -0.5F, 0.5F, 0F); // Box 142
		bodyDoorOpenModel[0].setRotationPoint(-21.5F, -13.5F, -28F);
		bodyDoorOpenModel[0].rotateAngleX = -1.91986218F;

		bodyDoorOpenModel[1].addShapeBox(0F, -2.5F, -38F, 13, 1, 2, 0F,-2F, 0.2F, 0F, -6F, 0.2F, 0F, 0F, 0F, -0.5F, 0F, 0F, 0F, -2F, 0F, 0F, -6F, 0F, 0F, 0F, 0.5F, -0.5F, 0F, 0.5F, 0F); // Box 143
		bodyDoorOpenModel[1].setRotationPoint(-19.5F, -13.5F, -28F);
		bodyDoorOpenModel[1].rotateAngleX = -1.91986218F;

		bodyDoorOpenModel[2].addShapeBox(0F, 0F, 0F, 26, 3, 36, 0F,-0.5F, 0F, 0F, -0.5F, 0F, 0F, -11F, 1.5F, 0.5F, -2F, 1.5F, 0F, -0.5F, 0.5F, 0F, -0.5F, 0.5F, 0F, -11F, -3F, 0.5F, -2F, -3F, 0F); // Box 148
		bodyDoorOpenModel[2].setRotationPoint(-21.5F, -13.5F, 28F);
		bodyDoorOpenModel[2].rotateAngleX = 1.91986218F;

		bodyDoorOpenModel[3].addShapeBox(0F, -1.5F, 36F, 13, 1, 2, 0F,0F, 0F, 0F, 0F, 0F, -0.5F, -6F, 0.2F, 0F, -2F, 0.2F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, -0.5F, -6F, 0F, 0F, -2F, 0F, 0F); // Box 149
		bodyDoorOpenModel[3].setRotationPoint(-19.5F, -13.5F, 28F);
		bodyDoorOpenModel[3].rotateAngleX = 1.91986218F;
	}

	private void initbodyDoorCloseModel_1()
	{
		bodyDoorCloseModel[0] = new ModelRendererTurbo(this, 57, 65, textureX, textureY); // Box 65
		bodyDoorCloseModel[1] = new ModelRendererTurbo(this, 257, 33, textureX, textureY); // Box 66
		bodyDoorCloseModel[2] = new ModelRendererTurbo(this, 57, 65, textureX, textureY); // Box 146
		bodyDoorCloseModel[3] = new ModelRendererTurbo(this, 257, 33, textureX, textureY); // Box 147

		bodyDoorCloseModel[0].addShapeBox(0F, 0F, -36F, 26, 3, 36, 0F,-2F, 1.5F, 0F, -11F, 1.5F, 0.5F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, -2F, -3F, 0F, -11F, -3F, 0.5F, -0.5F, 0.5F, 0F, -0.5F, 0.5F, 0F); // Box 65
		bodyDoorCloseModel[0].setRotationPoint(-21.5F, -10.5F, -26F);

		bodyDoorCloseModel[1].addShapeBox(0F, 0F, -38F, 13, 1, 2, 0F,-2F, 0.2F, 0F, -6F, 0.2F, 0F, 0F, 0F, -0.5F, 0F, 0F, 0F, -2F, 0F, 0F, -6F, 0F, 0F, 0F, 0.5F, -0.5F, 0F, 0.5F, 0F); // Box 66
		bodyDoorCloseModel[1].setRotationPoint(-19.5F, -12F, -26F);

		bodyDoorCloseModel[2].addShapeBox(0F, 0F, 0F, 26, 3, 36, 0F,-0.5F, 0F, 0F, -0.5F, 0F, 0F, -11F, 1.5F, 0.5F, -2F, 1.5F, 0F, -0.5F, 0.5F, 0F, -0.5F, 0.5F, 0F, -11F, -3F, 0.5F, -2F, -3F, 0F); // Box 146
		bodyDoorCloseModel[2].setRotationPoint(-21.5F, -10.5F, 26F);

		bodyDoorCloseModel[3].addShapeBox(0F, 0F, 36F, 13, 1, 2, 0F,0F, 0F, 0F, 0F, 0F, -0.5F, -6F, 0.2F, 0F, -2F, 0.2F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, -0.5F, -6F, 0F, 0F, -2F, 0F, 0F); // Box 147
		bodyDoorCloseModel[3].setRotationPoint(-19.5F, -12F, 26F);
	}
}