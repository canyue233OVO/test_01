...
public class GrenadeType extends ShootableType
{
	...
	public boolean penetratesEntities = false, penetratesBlocks = false, randomDirection = false;
	...
	//2024 so grenade can try to be a tank turret
	public String vehicleReference = null;
	...
	protected void read(String[] split, TypeFile file)
	{
		...
		try
		{
			...
			else if(split[0].equals("RandomDirection")) //added by labjac 2024
				randomDirection = Boolean.parseBoolean(split[1].toLowerCase());
			
			//2024 for crude attempt at deturret
			else if(split[0].equals("vehicleReference")) //added by labjac 2024
				vehicleReference = split[1];
