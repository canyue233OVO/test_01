...
public class EntityNuMuzzle extends EntityFX
{
	public static ResourceLocation icon = new ResourceLocation("flansmod", "particle/NuMuzzle.png");
	public EntityNuMuzzle(World w, double px, double py, double pz, double mx, double my, double mz)
	{
    ...
    public void renderParticle(Tessellator par1Tessellator, float par2, float par3, float par4, float par5, float par6, float par7)
    {
        ...
        float scale = 0.2F + ((this.particleAge)*0.3F);
