...
public class EntityNuFlash extends EntityFX
{
	public static ResourceLocation icon = new ResourceLocation("flansmod", "particle/NuFlash.png");
	public EntityNuFlash(World w, double px, double py, double pz, double mx, double my, double mz)
	{
		...
		this.motionY = 0;
		this.motionZ = 0;
		icon = new ResourceLocation("flansmod", "particle/NuFlash.png");
	}
    ...
    public void renderParticle(Tessellator par1Tessellator, float par2, float par3, float par4, float par5, float par6, float par7)
    {
    	...
    	FMLClientHandler.instance().getClient().renderEngine.bindTexture(new ResourceLocation("flansmod", "particle/NuFlash.png"));

        float scale = 3F + ((this.particleAge)*0.5F);
