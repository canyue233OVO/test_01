...
public class ModelF6F3 extends ModelPlane //Same as Filename
{
	int textureX = 1024;
	int textureY = 1024;

	public ModelF6F3() //Same as Filename
	{
	...
	{
		hudModel[0] = new ModelRendererTurbo(this, 336, 88, textureX, textureY); // Box 814
		...
		hudModel[0].setRotationPoint(-36.5F, -75F, 0F);
