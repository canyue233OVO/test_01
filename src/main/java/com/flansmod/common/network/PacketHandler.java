...
public class PacketHandler extends MessageToMessageCodec<FMLProxyPacket, PacketBase>
{
	...
	public void initialise()
	{
		...
		registerPacket(PacketCurrentMissile.class); //baris tech
		registerPacket(PacketMissileWeight.class); //2024 ammo weight tech
		registerPacket(PacketTargetSwitch.class); //2024 missile target switch for planes
		...
		registerPacket(PacketShakeRecoil.class); //2024 new recoil packet
