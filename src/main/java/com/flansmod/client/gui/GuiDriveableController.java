...
public class GuiDriveableController extends GuiScreen
{
	...
	public void initGui()
	{
		if(mc.gameSettings.thirdPersonView == 1 && plane != null && plane.getCamera() != null && mc.renderViewEntity != null && mc.thePlayer != null) //added ivermectin june 4 2023 to prevent random crashes wally suffered from
    ...
    {
      		 EntityPlayer player = null; //rearrange this entity to prevent nullpointer june 6 2023
    		 if (plane != null && plane.getControllingEntity() != null &&  plane.getControllingEntity() instanceof EntityPlayer)  //reduced symptoms ivermectin june 6 2023  (june 4 attempt had annoying side effect)
		 player = (EntityPlayer)plane.getControllingEntity(); //allow normal player assigned after passing ivermectin inspection june 6 2023
		if(player != mc.thePlayer)
		{
			mc.displayGuiScreen(null);
			return;
