...
public class ModelRendererTurbo extends ModelRenderer
{
	...
	*/
	...
	private static float getPixelSize(float wScale, float hScale, float dScale, int wDir, int hDir, int checkDir, int texPosX, int texPosY)
	{
	...
	public void render(float worldScale, boolean oldRotateOrder)
	{
		...
		} else
		{
		 ...
		 if(glow) { //bye bye lag generator 2 2025
			glowOff();
		}
