...
public class TeamsManager
{
	...
	public static boolean voting = false, explosions = true, driveablesBreakBlocks = false, raiding = true, violence = false, bleeding = false, movieProp = false,
	...
	//variable packet rate  9 4 23
	public static int planeRate = 1;
	public static int vehicleRate = 1;
	public static int seatRate = 1;
	
	//for RVI overlay system 2025
	public static int rviRange = 100; //default no overlay until enemy is 100m from you
	public static int rviRate = 5;  //default spam the overlay packet every 5 ticks
	...
	private static void setPlayersNextSpawnpoint(EntityPlayerMP player, ChunkCoordinates coords)
	{
	...
	private void loadPerWorldData(Event event, World world)
	{
		...
		try
		{
			...
			//make vehicles drive themselves for video
			movieProp = tags.getBoolean("movieProp");
			...
			driveablesBreakBlocks = false; //perma remove
			//driveablesBreakBlocks = tags.getBoolean("BreakBlocks");  old
	...
	private void savePerWorldData(Event event, World world)
	{
		...
		try
		{
			...
			//make vehicle drive itself for movie prop
			tags.setBoolean("movieProp", movieProp);
			...
			tags.setBoolean("BreakBlocks", false); //perma disable
			//tags.setBoolean("BreakBlocks", driveablesBreakBlocks); old
