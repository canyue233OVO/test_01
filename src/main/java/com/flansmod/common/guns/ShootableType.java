...
public abstract class ShootableType extends InfoType
{
	...
	public boolean canDroneDrop = false; //2024 for drones that drop grenades
	...
	protected void read(String[] split, TypeFile file)
	{
		...
		try
		{
			...
			else if(split[0].equals("CringeExplodeOnImpact") || split[0].equals("CringeDetonateOnImpact")) //censored since it kept breaking bullets
			...
			else if(split[0].equals("canDroneDrop")) //2024 for drones that drop grenades
				canDroneDrop = Boolean.parseBoolean(split[1].toLowerCase());	
