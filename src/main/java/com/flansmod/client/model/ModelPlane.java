...
public class ModelPlane extends ModelDriveable
{
	...
	/*  attempt at reusing turret loss for wing loss
	public void renderWingLoss(DriveableType type)
	{
		...
		super.render(type);
		GL11.glScalef(100, 100, 100);  //if you cant stop body from rendering, just make whole thing 100x smaller, except wing!!!
		renderPart(leftWingModel);
		GL11.glPopMatrix();
	}
	*/
